...
(defun tarp/gray-get-colors (background)
...
(let*
  (
    ...
    (normal-parts (tarp/gray-get-colors background))
  ...
  (setq tarp/theme*
    (ht
      ...
      (:focused
        (tarp/gray-get-colors background+)
        ;; (ht-merge
        ;;   normal-parts
      ...
      ;; weak emphasis
      (:weak (tarp/gray-get-colors background>))

      ;; strong emphasis
      (:strong (tarp/gray-get-colors background>>))))
...
(deftheme tarp-gray)
(tarp/base16-theme-define 'tarp-gray)

(provide-theme 'tarp-gray)
